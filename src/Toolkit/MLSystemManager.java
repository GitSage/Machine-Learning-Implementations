...
public class MLSystemManager {
	...
	public SupervisedLearner getLearner(String model, Random rand) throws Exception
	{
		...
		else if (model.equals("neuralnet")) return new NeuralNet(rand); // backpropation
		else if (model.equals("decisiontree")) return new DecisionTree();
		else if (model.equals("knn")) return new KNearestNeighbors(10);
	...
	public void run(String[] args) throws Exception {
		...
		if (evalMethod.equals("training"))
		{
			...
			// grab everything except the last column
			...
			// will store the accuracy of the result
	...
	private class ArgParser {
		...
		public ArgParser(String[] argv) {
			try{
                ...
                System.out.println("Toolkit.MLSystemManager -L [learningAlgorithm] -A [ARFF_File] -E [evaluationMethod] {[extraParamters]} [OPTIONS]\n");
                ...
                System.out.println("Toolkit.MLSystemManager -L [learningAlgorithm] -A [ARFF_File] -E training");
                System.out.println("Toolkit.MLSystemManager -L [learningAlgorithm] -A [ARFF_File] -E static [testARFF_File]");
                System.out.println("Toolkit.MLSystemManager -L [learningAlgorithm] -A [ARFF_File] -E random [%_ForTraining]");
                System.out.println("Toolkit.MLSystemManager -L [learningAlgorithm] -A [ARFF_File] -E cross [numOfFolds]\n");
                System.exit(0);
            }
